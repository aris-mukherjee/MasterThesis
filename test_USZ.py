...
def inference(args, model, test_save_path=None):
    ...
    metric_list = metric_list / num_test_subjects   
    ...
    if measure_calibration:
        ...
        plt.show()
        plt.savefig(f'/scratch_net/biwidl217_second/arismu/Data_MT/plots/{model_type}_USZ.png')
...
if __name__ == "__main__":
    ...
    if args.is_savenii:
        ...
        test_save_path = os.path.join(args.test_save_dir, f'USZ_{model_type}_test_seed{seed}')
