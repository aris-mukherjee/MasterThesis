...
def inference(args, model, test_save_path=None):
    ...
    writer = SummaryWriter(f'/scratch_net/biwidl217_second/arismu/Tensorboard/2022/FETS/{model_type}/TTA/TEST/Entropy/' + f'TD2_FETS_{model_type}_log_seed{seed}_da{data_aug}')
