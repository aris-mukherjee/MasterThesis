...
def inference(args, model, test_save_path=None):
    ...
    writer = SummaryWriter(f'/scratch_net/biwidl217_second/arismu/Tensorboard/2022/FETS/{model_type}/TTA/TEST/' + f'TD2_FETS_{model_type}_log_seed{seed}_da{data_aug}')
 ...
 """
        ...
        metric_whole, metric_enhancing, metric_core, pred_l, label_l = test_single_volume_FETS(image, label, model, i2n_module_t1, i2n_module_t1ce, i2n_module_t2, i2n_module_flair, use_tta, tta_epochs, writer, classes=args.num_classes, dataset = 'FETS_TD2', optim = 'ADAM', model_type = f'{model_type}', seed = '{seed}', patch_size=[args.img_size, args.img_size],
...
if __name__ == "__main__":
    ...
    if args.is_savenii:
        args.test_save_dir = f'../predictions_2022/FETS/{model_type}/TTA/'
