...
def inference(args, model, test_save_path=None):
    ...
    writer = SummaryWriter(f'/scratch_net/biwidl217_second/arismu/Tensorboard/2022/FETS/{model_type}/TTA/TEST/Entropy/' + f'TD1_FETS_{model_type}_log_seed{seed}_da{data_aug}__REPORT')
    ...
    if measure_calibration:
        ...
        fig.savefig(f'/scratch_net/biwidl217_second/arismu/Data_MT/plots/FETS_TD1_calibration_{model_type}_da{data_aug}_seed{seed}.png')
