...
def inference(args, model, test_save_path=None):
    ...
    for sub_num in range(num_test_subjects):
        ...
        metric_i, pred_l, label_l = test_single_volume(image, label, model, classes=args.num_classes, dataset = 'UCL', optim = 'ADAM', model_type = f'{model_type}', seed = f'{seed}', patch_size=[args.img_size, args.img_size],
    ...
    if measure_calibration:
        ...
        plt.show()
        plt.savefig(f'/scratch_net/biwidl217_second/arismu/Data_MT/plots/{model_type}_UCL.png')
...
if __name__ == "__main__":
    ...
    if args.is_savenii:
        ...
        test_save_path = os.path.join(args.test_save_dir, f'UCL_{model_type}_test_seed{seed}')
