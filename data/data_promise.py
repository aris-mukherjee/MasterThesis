        ...
        for filename in fileList:
            ...
            if '.mhd' in filename:
                ...
                if 'segmentation' not in filename:
                    ...
                    img = sitk.ReadImage("/itet-stor/arismu/bmicdatasets-originals/Originals/Challenge_Datasets/Prostate_PROMISE12/TrainingData/" + filename + '.mhd')
                    sitk.WriteImage(img, "/scratch_net/biwidl217_second/arismu/Data_MT/PROMISE/" + filename + ".nii.gz") 
                    ...
                    if int(patient_id) in sub_dataset_ids:
                        ...
                        filepath = "/scratch_net/biwidl217_second/arismu/Data_MT/PROMISE/" + filename + '.nii.gz'
...
def prepare_data(input_folder,
    ...
    for train_test in ['test', 'train', 'validation']:
        ...
        for patient_id in patient_ids_list[train_test]:
            ...
            # ================================    
            if os.path.isfile(filepath_bias_corrected_nii_format):
                img = utils.load_nii(img_path = filepath_bias_corrected_nii_format)[0]
            else:
                subprocess.call(["/itet-stor/arismu/bmicdatasets_bmicnas01/Sharing/N4_th", filepath_orig_nii_format, filepath_bias_corrected_nii_format])
                img = utils.load_nii(img_path = filepath_bias_corrected_nii_format)[0]
            ...
            scale_vector = [pixel_size[0] / target_resolution, pixel_size[1] / target_resolution]
            ...
            for zz in range(img.shape[2]):
                ...
                if patient_id in ['26', '27', '28', '29', '30', '31', '32']:
                    ...
                    scale_vector_tmp = [0.65 / target_resolution, 0.65 / target_resolution]
